...
import IndianPVC from "../assests/PVC/Indian.png";
import AlstonePVC from "../assests/PVC/Alstone.png";
import BlackCobraPVC from "../assests/PVC/Black-cobra.png";

const pvcData = [
  
  {
    id: 1,
    name: "Black Cobra PVC",
    image: BlackCobraPVC,
    features: [
      "High-density black core",
      "Superior screw-holding strength",
      "UV-stable coloured cap layer",
      "Anti-static, fingerprint resistant",
      "Ready-to-use designer surface",
    ],
    specifications: {
      material: "High-density PVC foam",
      thickness: "5 mm – 18 mm",
      sheetSize: "8 ft × 4 ft",
      warranty: "15 years",
      finish: "Black core + coloured cap",
    },
  },
  {
    id: 2,
    name: "Indian PVC Board",
    image: IndianPVC,
    features: [
      "Made in India – cost effective",
      "Quick local availability",
      "Low thermal conductivity",
      "Eco-friendly lead-free option",
      "Good printability for UV inks",
    ],
    specifications: {
  ...
  },
  {
    ...
    specifications: {
      material: "Celuka-process PVC foam",
      thickness: "3 mm – 30 mm",
      sheetSize: "8 ft × 4 ft",
      warranty: "15 years",
      finish: "Satin / Gloss / Texture",
    },
  },
];
