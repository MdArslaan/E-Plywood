...
const mdfData = [
  ...
  {
    id: 1,
    name: "Green Panel MDF",
    image: GreenPanelMDF,
    features: [
      "Zero-swell moisture-resistant grade",
  ...
  },
  {
    ...
    image: GreenplyMDF,
    features: [
      "Brand-assured core consistency",
      "Ultra-smooth surface for veneer",
      "Pre-primed & fire-retardant options",
      "Anti-bacterial & anti-fungal",
      "Ready-to-use designer colours",
    ],
    specifications: {
      material: "Hardwood fibres",
